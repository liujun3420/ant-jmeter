...
public class MailReport {
     ...
     * @return String
     */
    public static String reportHtml(int allCase,int passCase,long runTime,String runUser,String noteInfo,String failCaseString) {
        ...
        String h = "<TABLE Align='center' width=1000px>\n" +
                ...
                "            <td align=\"center\" style=\"background: #eeeee0;white-space: nowrap;\">" + runUser + "</td>\n" +
                "            <td align=\"center\" style=\"background: #eeeee0;white-space: nowrap;\">" + noteInfo + "</td>\n" +
                "        </tr>\n" +
                "\n" +
                "    </table>\n";
        String detail =
